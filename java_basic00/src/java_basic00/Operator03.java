...
public class Operator03 {
	public static void main(String[] args) {
		...
		System.out.println("1. 10 + ++num = " + result);
		...
		++num;
		result = 10 + num;
		System.out.println("2. 10 + ++num = " + result);
		...
		System.out.println("3. 10 + ++num = " + result);
		
		// 3번의 결과값을 1번, 2번과 같게 하고 싶다면
		++result;
		System.out.println("4. 10 + ++num = " + result);
		System.out.println();
		...
		ageResult = (19 <= age && age < 60 )? "통과" : "거절";
		
		System.out.println("회원님의 나이는 " + age + "세 이므로, " + ageResult + "입니다.");
